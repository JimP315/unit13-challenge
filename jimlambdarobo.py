...
#import requests
#response = requests.get('https://ap-southeast-2.console.aws.amazon.com/lex/home?region=ap-southeast-2#bot-editor:bot=RoboAdviser')
...
def validate_data(age, investment_amount, intent_request):
    ...
    if age is not None:
        ...
        if age > 64:
            return build_validation_result(
                False,
                "age",
                "You should be under the age of 65 to utilise  this service, "
    ...
    if age is not None: 
        ...
        #age = parse_int(age)
        #if age < 0: #this to be more realistic since below zero makes no sense, just have it below 18 
            #return build_validation_result(
                #False,
                #"age",
                #"Your age cannot be negative, please supply a different agee.",
            #)
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum investment amount must be at least  5,000 USD to use this service, "
                
                "please provide a greater amount.",
            )
 
  # A True result will be returned if age or amount are valid
...
def get_investment_recommendation(risk_level):
    ...
    """
    #I tried this below code but it didnt work 
    #risk_levels = {
    ...
    initial_recommendation = risklevel(risk_level)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """{} thank you for your inputs;
            based on the risk level you selected, my recommendation is to choose an investment portfolio with {}
            """.format(
